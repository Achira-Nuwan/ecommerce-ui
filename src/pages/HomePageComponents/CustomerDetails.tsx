...
function CustomerDetails() {
    ...
    const {regCustomer, setRegCustomer} = userContext!;
            ...
            <Box>
                <Box>
                    ...
                    <Box sx={{ backgroundColor: "#F1EFEC", py: 4, px: 8, mt: 3 }}>
                            ...
                            <Box sx={{ borderTop: "1px solid #E0E0E0", pt: 3, mt: 4 }}>
                                ...
                                <Box>
                                    ...
                                    <Box sx={{ width: "100%", mt: 3, display: "flex", gap: 4 }}>
                                        ...
                                        <Box sx={{ width: "100%", mt: 3 }}>                                            <Typography variant="body2" sx={{ textAlign: "left" }}>State / Province</Typography>
                        ...
                        {/*SignUp Model */}
                        <SignUp open={signUp} onClose={signUpModelClose}/>
                    </Box>
                </Box>
            </Box>
        </Box>
